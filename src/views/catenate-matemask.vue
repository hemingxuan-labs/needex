...
<template>
    <div>
        <div class="container">
            <div class="d-flex-center flex-column" style="width: 100%">
                <p class="my-4 fs-6 text-center mt-8" style="max-width: 488px; color: #ffffff80">
                    Needex will lead you to re experience the complete on chain trading behavior
                    using the order book model
                </p>
                <div class="matemask-box px-4 py-5">
                    <div class="matemask-content d-flex-between-center" @click="onConnectClick">
                        <div class="d-none d-sm-block mr-2" id="logo-container"></div>
                        <img
                            class="d-block d-sm-none mr-2"
                            src="https://upload.wikimedia.org/wikipedia/commons/3/36/MetaMask_Fox.svg"
                            style="width: 80px; height: 80px" />
                        <div>
                            <p class="fs-5">MetaMask</p>
                            <p class="fs-6" style="color: rgb(156 163 175)">
                                Connect using browser wallet
                            </p>
                        </div>
                        <i class="iconfont icon-arrow-right-bold fs-3"></i>
                    </div>
                </div>
            </div>
        </div>
...
// console.log(JSON.parse(JSON.stringify(route)), 'routerouteroute')
const onConnectClick = async () => {
    await switchChain('324')
